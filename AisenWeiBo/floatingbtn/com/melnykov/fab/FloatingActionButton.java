...
public class FloatingActionButton extends ImageButton {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        mVisible = true;
        mColorNormal = getColor(R.color.floatingbtn_material_blue_500);
        mColorPressed = getColor(R.color.floatingbtn_material_blue_600);
        ...
        if (attr != null) {
            try {
                mColorNormal = attr.getColor(R.styleable.FloatingActionButton_fab_colorNormal,
                    getColor(R.color.floatingbtn_material_blue_500));
                mColorPressed = attr.getColor(R.styleable.FloatingActionButton_fab_colorPressed,
                    getColor(R.color.floatingbtn_material_blue_600));
